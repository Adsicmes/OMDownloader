...
from packages.model.osu_db.osu_db import OsuDbModel
from . import buffer


class OsuDb:
    def __init__(self, filepath: PathLike):
        self.dbContent: OsuDbModel
        self.filepath = filepath
        self.readFile()

    def readFile(self):
        """Read osu_db file"""
        with open(self.filepath, "rb") as db:
        ...
        db_info: OsuDbModel
        self.dbContent = db_info

    def getAllBeatmapsetIds(self) -> set[int]:
        return set([bm["beatmapset_id"] for bm in self.dbContent["beatmaps"]])

    def getAllData(self) -> OsuDbModel:
